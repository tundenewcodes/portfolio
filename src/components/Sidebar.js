            ...
            <ul
              ...
              <li>
                <a
                  ...
                  href='mailto:fadipe11@gmail.com'
                  target='/blank'>
              ...
              <li>
                <a
                  className='dropdown-item text-black'
                  href='https://linkedin.com/in/tunde-fadipe-149490150'
                  target='/blank'>
              ...
              <li>
                <a
                  className='dropdown-item text-black'
                  href='https://twitter.com/flourish015?t=dtqS_AAqZDaEnoaFu6d5BA&s=09'
                  target='/blank'>
                  <AiFillTwitterCircle className='fs-5' /> Twitter
                </a>
              </li>
              <li>
                {' '}
              ...
              <li>
                <a
                  className='dropdown-item text-black'
                  href='https://github.com/tundenewcodes'
                  target='/blank'>
