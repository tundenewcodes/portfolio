...
function MyWork() {
      ...
      const [showFrontendProjects, setShowFrontendProjects] =
        useState(false)
      const [
        showBackendDjangoProjects,
        setShowBackendDjangoProjects,
      ] = useState(false)
      const [showBackendNodeProjects, setShowBackendNodeProjects] =
        useState(false)
      const [showBackendProjects, setShowBackendProjects] =
        useState(false)
      const toggleAllProjects = () => {
        setShowAllProjects(true)
        setShowFrontendProjects(false)
        setShowBackendDjangoProjects(false)
        setShowBackendNodeProjects(false)
        setShowBackendProjects(false)
      }
      const toggleFrontendProjects = () => {
      ...
      const toggleBackendDjangoProjects = () => {
        setShowAllProjects(false)
        setShowFrontendProjects(false)
        setShowBackendDjangoProjects(true)
        setShowBackendNodeProjects(false)
        setShowBackendProjects(false)
      }
      const toggleBackendNodeProjects = () => {
        setShowAllProjects(false)
        setShowFrontendProjects(false)
        setShowBackendDjangoProjects(false)
        setShowBackendNodeProjects(true)
        setShowBackendProjects(false)
      }
    ...
    <Fragment>
      <div className='col p-4'>
        <div className='p-4 slide-in-top'>
          ...
          <select className='form-select form-select-lg mb-3' id='select'  onChange={changeProject}>
            <option value='' onClick={toggleAllProjects}>
              {' '}
              Please choose a project niche--
            </option>
            <option value='All-projects' onClick={toggleAllProjects}>
              {' '}
              All Projects
            </option>
            <option
            ...
            <option
              ...
              onClick={toggleFrontendProjects}>
              {' '}
              FrontEnd Projects
            </option>
            <option
          ...
          <div>
            ...
            {showBackendDjangoProjects && <BackendDjangoProjects />}{' '}
            {showBackendNodeProjects && <BackendNodeProjects />}{' '}
            {showBackendProjects && <BackendProjects />}{' '}
            {showFrontendProjects && <FrontendProjects />}{' '}
          </div>
        </div>
      </div>
    </Fragment>
